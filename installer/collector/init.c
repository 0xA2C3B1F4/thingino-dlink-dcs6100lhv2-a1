...
static void collect_existing_recovery_preflight(void)
{
    ...
    copy_vendor_file(
        "/stock/lib/modules/tx-isp-t31.ko", VENDOR_FILES "/tx-isp-t31.ko",
        TXISP_SIZE, TXISP_SHA256, 1);
    copy_vendor_file(
        "/stock/lib/modules/sensor_os02g10_t31.ko",
        VENDOR_FILES "/sensor_os02g10_t31.ko",
        SENSOROS02G10_SIZE, SENSOROS02G10_SHA256, 1);
    copy_vendor_file(
        "/stock/etc/sensor/os02g10-t31.bin", VENDOR_FILES "/os02g10-t31.bin",
        OS02G10IQ_SIZE, OS02G10IQ_SHA256, 1);
    write_new_file(
