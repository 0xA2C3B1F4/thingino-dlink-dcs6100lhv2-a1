export const routes = {
  ...
  config: {
    ...
    motionNtfy: "/api/v1/config/motion-ntfy",
    motionEmail: "/api/v1/config/motion-email",
    motionFtp: "/api/v1/config/motion-ftp",
    motionGotify: "/api/v1/config/motion-gotify",
    motionTelegram: "/api/v1/config/motion-telegram",
    motionWebhook: "/api/v1/config/motion-webhook",
    network: "/api/v1/config/network",
    osdMetadata: "/api/v1/config/osd-metadata",
  ...
  files: {
    list: (path: string, cursor?: string) => `/api/v1/files?cd=${encodeURIComponent(path)}${cursor === undefined ? "" : `&cursor=${encodeURIComponent(cursor)}`}`,
  ...
  recorderTimelapse: "/api/v1/recorder?domain=timelapse",
  recorderStream: (channel: 0 | 1) => `/api/v1/recorder?channel=${channel}`,
  runtime: {
    ...
    motionNtfy: "/api/v1/runtime/motion-ntfy",
    motionEmail: "/api/v1/runtime/motion-email",
    motionFtp: "/api/v1/runtime/motion-ftp",
    motionGotify: "/api/v1/runtime/motion-gotify",
    motionTelegram: "/api/v1/runtime/motion-telegram",
    motionWebhook: "/api/v1/runtime/motion-webhook",
