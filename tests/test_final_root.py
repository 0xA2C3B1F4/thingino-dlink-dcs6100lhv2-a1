...
class FinalRootTests(unittest.TestCase):
    ...
    def test_prudynt_media_profile_matches_live_color_and_hardware_osd(self) -> None:
        ...
        self.assertEqual(document["sensor"], {"model": "os02g10", "fps": 25})
        self.assertEqual(
            document["stream0"],
            {
                "enabled": True,
    ...
    def test_camera_bundle_replaces_only_vendor_libraries(self) -> None:
        with tempfile.TemporaryDirectory() as directory_name:
            ...
            before = final_root._snapshot_native_media(root)
            ...
            final_root._require_native_media_unchanged(root, before)
