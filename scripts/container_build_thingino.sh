...
(
	...
	runuser -u builder -- node scripts/build.mjs \
		"$webui_toolchain/node_modules/esbuild/lib/main.js"
)
...
printf '%s  %s\n' \
	...
	10a133f02022bab9c3e0d765c7acb4fd049758cf49cb3affc8e7618951288139 "$output_dir/target/usr/lib/libalog.so" \
	d01fea85b5aa9e08bb3d97d3f8b592a3cafe2e1e84d5c19ba4999d2123f70c4b "$output_dir/target/usr/lib/libsysutils.so" \
	f892759f47e0296ea175bf4247f661a11381037bafec7800326298d73d0a7273 "$output_dir/target/usr/lib/libaudioProcess.so" \
	| sha256sum -c -
grep -qx 'CONFIG_IPV6=y' "$linux_config"
