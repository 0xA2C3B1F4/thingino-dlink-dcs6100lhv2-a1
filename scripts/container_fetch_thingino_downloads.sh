...
common_env="HOME=/home/builder LC_ALL=C.UTF-8 LANG=C.UTF-8 TZ=UTC SOURCE_DATE_EPOCH=$source_epoch THINGINO_CONTAINER_BUILD=1 CAMERA=$profile PRISTINE=1 CCACHE_DISABLE=1 BR2_DL_DIR=$source_dir/dl THINGINO_OUTPUT_DIR=$output_dir DCS6100_VENDOR_BUNDLE_DIR=$workspace/empty DCS6100_AUDIOPROCESS_LINK_FILE=$workspace/empty/audio-link DCS6100_RUST_TOOLCHAIN_DIR=$workspace/empty DCS6100_RUST_SOURCE_DIR=$workspace/empty DCS6100_INGENIC_TOOLCHAIN_DIR=$workspace/empty WORKFLOW=1"
