...
- thingino/0024-retry-prudynt-until-media-ready.patch makes a normal boot wait
  for the D-Link media-ready marker and retries failed Prudynt initialization
  instead of treating a successful detached fork as a working camera stream.
...
All twenty Thingino patches have been checked in order against firmware commit
